...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Sistema Familiar',
        short_name: 'SistemaFam',
        description: 'Sistema de gestão familiar - Saúde e Manutenção',
        theme_color: '#ffffff',
        icons: [
          {
            src: 'pwa-192x192.png',
  ...
  server: {
    ...
    proxy: {
      '/api': {
        // Use VITE_PROXY_TARGET no .env (ex: http://localhost:8081) ou padrão 8001
